...
class Wagency {
	...
	public function theme_setup() {
		 ...
		 * replace to change 'wagency' to the name of your theme in all
		 * template files.
		 */
		load_theme_textdomain( 'wagency', get_template_directory() . '/languages' );

		// This theme uses wp_nav_menu() in one location.
		register_nav_menu( 'atiframebuilder_top_menu', esc_attr__( 'Header Menu', 'wagency' ) );
...
$atiframe_theme = Wagency::get_instance();
