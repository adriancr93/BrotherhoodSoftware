    ...
    */
    ...
    public static function title_404() {
        ...
        if ( isset( $secretlab['404_title'] ) ) {
	        ...
	        echo esc_html__( 'Page not found', 'wagency' );
        }
    }
    ...
    public static function descr_404() {
        ...
        if ( isset( $secretlab['404_descr'] ) ) {
	        ...
	        echo esc_html__( 'It looks like nothing was found at this location. Maybe try a search?', 'wagency' );
        }
    }
    ...
    public static function icon_404() {
        ...
        if ( ! empty( $secretlab['404_icon']['url'] ) ) {
            echo '<img src="' , esc_url( $secretlab['404_icon']['url'] ) , '" alt="' , esc_attr__( '404 Not Found', 'wagency' ) , '" />';
        }
    }
            ...
            <div class="nav-links clearfix">';
                if ( get_next_posts_link() ) {
                    echo '<div class="nav-previous alignleft">';
                        next_posts_link(  '<i class="nat-arrow-left8"></i> '.esc_attr__( 'Older posts', 'wagency' ) );
                    echo '</div>';
                }
                if ( get_previous_posts_link() ) {
                    echo'<div class="nav-next alignright">';
                        previous_posts_link( esc_attr__( 'Newer posts', 'wagency' ).' <i class="nat-arrow-right8"></i>' );
                    echo'</div>';
                }
            echo'</div><!-- .nav-links -->
        </nav><!-- .navigation -->';
