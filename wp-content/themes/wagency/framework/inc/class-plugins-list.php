...
class Atiframebuilder_Plugins {
	...
	public function __construct() {
		...
		$this->config = array(
			...
			'strings'      => array(
				...
				'installing'                      => esc_attr__( 'Installing Plugin: %s', 'wagency' ),
				// %1$s = plugin name
	...
	public static function getPlugins() {
		return array(
			...
			array(
				'name'     => esc_attr__( 'Caldera Forms', 'wagency' ),
				'slug'     => 'caldera-forms',
			...
			array(
				'name'     => esc_attr__( 'WooCommerce', 'wagency' ),
				'slug'     => 'woocommerce',
				'required' => false,
			),

			array(
				'name'         => esc_attr__( 'Marketing and SEO Booster', 'wagency' ),
				'slug'         => 'marketing-and-seo-booster',
				'required'     => true,
			),
			array(
				'name'         => esc_attr__( 'SecretLab Shortcodes', 'wagency' ),
			...
			array(
				'name'         => esc_attr__( 'KingComposer', 'wagency' ),
				'slug'         => 'kingcomposer',
			...
			array(
				'name'         => esc_attr__( 'KC Pro!', 'wagency' ),
				'slug'         => 'kc_pro',
			...
			array(
				'name'         => esc_attr__( 'Easy Forms for MailChimp', 'wagency' ),
				'slug'         => 'yikes-inc-easy-mailchimp-extender',
				'external_url' => 'https://www.yikesplugins.com/',
				'required'     => false,
			),
			array(
				'name'         => esc_attr__( 'Revolution Slider', 'wagency' ),
				'slug'         => 'revslider',
