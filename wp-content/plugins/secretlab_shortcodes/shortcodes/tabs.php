...
//	$kc->remove_map_param( 'kc_tabs', 'type' );
//
//	$kc->add_map_param(
...
function ssc_kc_tabs_map_filter( $atts, $base ) {
	...
	if ( 'kc_tabs' == $base ) {
		...
		if( !empty( $atts['params']['general'][1]['options'] ) ) {
			$atts['params']['general'][1]['options']['switcher_tabs'] = __(' Switcher', 'ssc');
		}
		...
		$css_map = array(
			array(
				...
				'Switcher Tab'     => array(
					array( 'property' => 'font-family,font-size,line-height,font-weight,text-transform,text-align', 'label'    => esc_html__( 'Font family', 'ssc' ), 'selector' => '.kc_tabs_nav, .kc_tabs_nav > div.ssc-switch-tab a,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab>a', ),
					array( 'property' => 'font-size,color,padding', 'label'    => esc_html__( 'Icon Size,Icon Color,Icon Spacing', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab a i,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab>a i', ),
					array( 'property' => 'color', 'label'    => esc_html__( 'Text Color', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab a, .kc_tabs_nav,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab>a', ),
					array( 'property' => 'background-color', 'label'    => esc_html__( 'Background Color', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab, +.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav', ),
					array( 'property' => 'background-color', 'label'    => esc_html__( 'Background Color tab item', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav div.ssc-switch-tab', ),
					array('property' => 'background', 'selector' => '.ui-tabs-nav > div.ssc-switch-tab'),
					array( 'property' => 'opacity', 'label'    => esc_html__( 'Opacity', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab' ),
					array('property' => 'display', 'label' => esc_html__( 'Display', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab'),
					array('property' => 'float', 'label' => esc_html__( 'Float', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab'),
					array( 'property' => 'border', 'label'    => esc_html__( 'Border', 'ssc' ), 'selector' => '+.kc_tabs .kc_wrapper .ui-tabs-nav > div.ssc-switch-tab > a'),
					array( 'property' => 'border', 'label'    => esc_html__( 'Border for Tab Box', 'ssc' ), 'selector' => '+.kc_tabs .kc_wrapper .ui-tabs-nav > div.ssc-switch-tab', ),
					array( 'property' => 'border-radius', 'label'    => esc_html__( 'Border-radius', 'ssc' ), 'selector' => '.kc_tabs_nav > div.ssc-switch-tab, .kc_tab.ui-tabs-body-active, .kc_tabs_nav,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab,.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav ~ div.kc_tab.ui-tabs-body-active,+.kc_vertical_tabs.tabs_right>.kc_wrapper>.ui-tabs-nav ~ div.kc_tab', ),
					array( 'property' => 'padding', 'label'    => esc_html__( 'Padding', 'ssc' ), 'selector' => '.kc_tabs_nav > div.ssc-switch-tab > a,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab>a', ),
					array( 'property' => 'margin', 'label'    => esc_html__( 'Margin Link', 'ssc' ), 'selector' => '.kc_tabs_nav > div.ssc-switch-tab > a,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab', ),
					array( 'property' => 'margin', 'label'    => esc_html__( 'Margin Tab', 'ssc' ), 'selector' => '.ui-tabs-nav>div.ssc-switch-tab', ),
					array( 'property' => 'width', 'label'    => esc_html__( 'Width', 'ssc' ), 'selector' => '.kc_tabs_nav > div.ssc-switch-tab,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab', ),
					array( 'property' => 'height', 'label'    => esc_html__( 'Height', 'ssc' ), 'selector' => '.kc_tabs_nav > div.ssc-switch-tab,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab', ),
					array('property' => 'fill', 'label' => esc_html__( 'Fill', 'ssc' ), 'selector' => 'div.ssc-switch-tab a svg'),
					array('property' => 'fill', 'label' => esc_html__( 'Fill Hover', 'ssc' ), 'selector' => 'div.ssc-switch-tab:hover a svg'),
					array( 'property' => 'width', 'label'    => esc_html__( 'SVG Width', 'ssc' ), 'selector' => 'div.ssc-switch-tab a svg', ),
					array( 'property' => 'height', 'label'    => esc_html__( 'SVG Height', 'ssc' ), 'selector' => 'div.ssc-switch-tab a svg', ),
					array( 'property' => 'display', 'label' => esc_html__( 'SVG Display', 'ssc' ), 'selector' => 'div.ssc-switch-tab a svg' ),
					array( 'property' => 'float', 'label' => esc_html__( 'SVG float', 'ssc' ), 'selector' => 'div.ssc-switch-tab a svg' ),
					array( 'property' => 'box-shadow', 'label'    => esc_html__( 'SVG Box Shadow', 'ssc' ), 'selector' => 'div.ssc-switch-tab a svg', ),
					array( 'property' => 'margin', 'label'    => esc_html__( 'SVG Margin', 'ssc' ), 'selector' => 'div.ssc-switch-tab a svg', ),
					array( 'property' => 'margin', 'label'    => esc_html__( 'SVG Margin Hover', 'ssc' ), 'selector' => 'div.ssc-switch-tab:hover a svg', ),
					array( 'property' => 'opacity', 'label'    => esc_html__( 'SVG Opacity', 'ssc' ), 'selector' => 'div.ssc-switch-tab a svg', ),
					array( 'property' => 'opacity', 'label'    => esc_html__( 'SVG Opacity Hover', 'ssc' ), 'selector' => 'div.ssc-switch-tab:hover a svg', ),
				),

				'Switcher Tab Hover'  => array(
					array( 'property' => 'color', 'label'    => esc_html__( 'Text Color', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab:hover a, .kc_tabs_nav div.ssc-switch-tab:hover, .kc_tabs_nav > .ui-tabs-active:hover a,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab>a:hover,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab.ui-tabs-active > a'),
					array( 'property' => 'color', 'label'    => esc_html__( 'Icon Color', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab:hover a i,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab>a:hover i,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab.ui-tabs-active > a i'),
					array( 'property' => 'background-color', 'label'    => esc_html__( 'Background Color', 'ssc' ), 'selector' => '.kc_tabs_nav > div.ssc-switch-tab:hover, .kc_tabs_nav > div.ssc-switch-tab:hover a, .kc_tabs_nav > div.ssc-switch-tab > a:hover,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab>a:hover,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab.ui-tabs-active > a'),
					array('property' => 'background', 'selector' => '.ui-tabs-nav > div.ssc-switch-tab a:hover'),

					array( 'property' => 'border', 'label'    => esc_html__( 'Border', 'ssc' ), 'selector' => '+.kc_tabs .kc_wrapper .ui-tabs-nav > div.ssc-switch-tab > a:hover', ),
					array('property' => 'fill', 'label' => esc_html__( 'Fill', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab a:hover svg'),
					array( 'property' => 'width', 'label'    => esc_html__( 'SVG Width', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab a:hover svg', ),
					array( 'property' => 'height', 'label'    => esc_html__( 'SVG Height', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab a:hover svg', ),
					array( 'property' => 'display', 'label' => esc_html__( 'SVG Display', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab a:hover svg' ),
					array( 'property' => 'float', 'label' => esc_html__( 'SVG float', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab a:hover svg' ),
					array( 'property' => 'box-shadow', 'label'    => esc_html__( 'SVG Box Shadow', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab a:hover svg', ),
					array( 'property' => 'padding', 'label'    => esc_html__( 'SVG Padding', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab', ),
					array( 'property' => 'margin', 'label'    => esc_html__( 'SVG Margin', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab a:hover svg', ),
					array( 'property' => 'opacity', 'label'    => esc_html__( 'SVG Opacity', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab a:hover svg', ),
				),
				'Switcher Tab Active' => array(
					array( 'property' => 'color', 'label'    => esc_html__( 'Text Color', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab.ui-tabs-active a,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab.ui-tabs-active > a', ),
					array( 'property' => 'color', 'label'    => esc_html__( 'Icon Color', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab.ui-tabs-active a i, .kc_tabs_nav > .ui-tabs-active:focus a i,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab.ui-tabs-active > a i', ),
					array( 'property' => 'background-color', 'label'    => esc_html__( 'Background Color', 'ssc' ), 'selector' => '.kc_tabs_nav > .ui-tabs-active:focus, .kc_tabs_nav > .ui-tabs-active, .kc_tabs_nav > .ui-tabs-active > a,+.kc_vertical_tabs>.kc_wrapper>.ui-tabs-nav>div.ssc-switch-tab.ui-tabs-active > a', ),
					array( 'property' => 'background-color', 'label'    => esc_html__( 'Background Color Active Tab', 'ssc' ), 'selector' => '.kc-tabs-slider-nav div.ssc-switch-tab.kc-title-active', ),
					array('property' => 'background', 'label' => esc_html__( 'Display', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab.ui-tabs-active a'),
					array( 'property' => 'border', 'label'    => esc_html__( 'Border', 'ssc' ), 'selector' => '+.kc_tabs .kc_wrapper .ui-tabs-nav > div.ssc-switch-tab.ui-tabs-active > a'),
					array( 'property' => 'opacity', 'label'    => esc_html__( 'Opacity', 'ssc' ), 'selector' => '+.kc_tabs .kc_wrapper .ui-tabs-nav > div.ssc-switch-tab.ui-tabs-active > a'),
					array('property' => 'fill', 'label' => esc_html__( 'Fill', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab.ui-tabs-active a svg'),
					array( 'property' => 'width', 'label'    => esc_html__( 'SVG Width', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab.ui-tabs-active a svg', ),
					array( 'property' => 'height', 'label'    => esc_html__( 'SVG Height', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab.ui-tabs-active a svg', ),
					array( 'property' => 'display', 'label' => esc_html__( 'SVG Display', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab.ui-tabs-active a svg' ),
					array( 'property' => 'float', 'label' => esc_html__( 'SVG float', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab.ui-tabs-active a svg' ),
					array( 'property' => 'box-shadow', 'label'    => esc_html__( 'SVG Box Shadow', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab.ui-tabs-active a svg', ),
					array( 'property' => 'padding', 'label'    => esc_html__( 'SVG Padding', 'ssc' ), 'selector' => '.kc_tabs_nav div.ssc-switch-tab.ui-tabs-active', ),
					array( 'property' => 'margin', 'label'    => esc_html__( 'SVG Margin', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab.ui-tabs-active a svg', ),
					array( 'property' => 'opacity', 'label'    => esc_html__( 'SVG Opacity', 'ssc' ), 'selector' => ' .kc_tabs_nav div.ssc-switch-tab.ui-tabs-active a svg', ),

				),
				'Switcher Tab Body'   => array(
					array( 'property' => 'border', 'label'    => esc_html__( 'Border', 'ssc' ), 'selector' => '.kc_wrapper > .ui-tabs-nav ~ div.kc_tab.ui-tabs-body-active'),
				),
				'Switcher Tab Image'   => array(
					array( 'property' => 'display', 'label' => esc_html__( 'Display', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab img' ),
					array( 'property' => 'float', 'label' => esc_html__( 'Float', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab img' ),
					array('property' => 'width', 'label' => esc_html__( 'Width', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab img'),
					array('property' => 'max-width', 'label' => esc_html__( 'Max-Width', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab img'),
					array('property' => 'height', 'label' => esc_html__( 'Height', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab img'),
					array( 'property' => 'margin', 'label'    => esc_html__( 'Margin', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab img'),
					array( 'property' => 'padding', 'label'    => esc_html__( 'Padding', 'ssc' ), 'selector' => '.ui-tabs-nav > div.ssc-switch-tab img'),
				),
				'Switcher'   => array(
					array( 'property' => 'opacity', 'label'    => esc_html__( 'Block Opacity', 'ssc' ), 'selector' => '.ssc-switch-btn', ),
					array( 'property' => 'border', 'label'    => esc_html__( 'Block Border', 'ssc' ), 'selector' => '.ssc-switch-btn'),
					array('property' => 'border-radius', 'label' => esc_html__( 'Block Border Radius', 'ssc' ), 'selector' => '.ssc-switch-btn'),
					array('property' => 'background', 'label' => esc_html__( 'Block Background', 'ssc' ), 'selector' => '.ssc-switch-btn'),
					array('property' => 'box-shadow', 'label' => esc_html__( 'Box Shadow', 'ssc' ), 'selector' => '.ssc-switch-btn'),
					array( 'property' => 'display', 'label' => esc_html__( 'Button Display', 'ssc' ), 'selector' => '.ssc-switch-btn:after' ),
					array( 'property' => 'float', 'label' => esc_html__( 'Button Float', 'ssc' ), 'selector' => '.ssc-switch-btn:after' ),
					array( 'property' => 'opacity', 'label'    => esc_html__( 'Button Opacity', 'ssc' ), 'selector' => '.ssc-switch-btn:after', ),
					array( 'property' => 'border', 'label'    => esc_html__( 'Button Border', 'ssc' ), 'selector' => '.ssc-switch-btn:after'),
					array('property' => 'border-radius', 'label' => esc_html__( 'Button Border Radius', 'ssc' ), 'selector' => '.ssc-switch-btn:after'),
					array('property' => 'background', 'label' => esc_html__( 'Button Background', 'ssc' ), 'selector' => '.ssc-switch-btn:after'),
					array('property' => 'box-shadow', 'label' => esc_html__( 'Button Box Shadow', 'ssc' ), 'selector' => '.ssc-switch-btn:after'),
					array( 'property' => 'display', 'label' => esc_html__( 'Block Display', 'ssc' ), 'selector' => '.ssc-switch-btn' ),
					array( 'property' => 'float', 'label' => esc_html__( 'Block Float', 'ssc' ), 'selector' => '.ssc-switch-btn' ),
				),
				'Switcher on Activ Hover'   => array(
					array( 'property' => 'opacity', 'label'    => esc_html__( 'Block Opacity', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next', ),
					array( 'property' => 'border', 'label'    => esc_html__( 'Block Border', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next'),
					array('property' => 'border-radius', 'label' => esc_html__( 'Block Border Radius', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next'),
					array('property' => 'background', 'label' => esc_html__( 'Block Background', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next'),
					array('property' => 'box-shadow', 'label' => esc_html__( 'Box Shadow', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next'),
					array( 'property' => 'display', 'label' => esc_html__( 'Button Display', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next:after' ),
					array( 'property' => 'float', 'label' => esc_html__( 'Button Float', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next:after' ),
					array( 'property' => 'opacity', 'label'    => esc_html__( 'Button Opacity', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next:after', ),
					array( 'property' => 'border', 'label'    => esc_html__( 'Button Border', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next:after'),
					array('property' => 'border-radius', 'label' => esc_html__( 'Button Border Radius', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next:after'),
					array('property' => 'background', 'label' => esc_html__( 'Button Background', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next:after'),
					array('property' => 'box-shadow', 'label' => esc_html__( 'Button Box Shadow', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next:after'),
					array( 'property' => 'display', 'label' => esc_html__( 'Block Display', 'ssc' ), 'selector' => '.ssc-switch-btn.switch-next' ),
				),
			),
		);
