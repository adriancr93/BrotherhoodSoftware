...
#></div>
<# } else if (undefined !== atts['type'] && atts['type'] == 'switcher_tabs'){ #>
	...
	<div class="kc_wrapper ui-tabs switcher-tabs kc_clearfix">
		<ul class="{{tab_nav_class}} switcher-nav ui-tabs-nav kc_clearfix">
			{{{ssc.front.ui.process_tab_switch_titles(data)}}}
		</ul>
