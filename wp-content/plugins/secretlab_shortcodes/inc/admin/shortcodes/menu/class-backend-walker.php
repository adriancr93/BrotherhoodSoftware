				...
				<div class="admin-sl-box_container">
					...
					<?php if( class_exists( 'SL_Icon_Manager' ) ){ ?>
						<div <?php if( $icon_type != 'icon_font' || 'none' == $link_type ) echo 'style="display:none;"' ; ?> class="admin-sl-box_option_inside admin-sl-box_option_inside_icon_font">
							...
							<button id="icon-select-<?php echo $item->ID; ?>" class="admin_sl_select_icon_button button-primary fr" data-id="<?php echo $item->ID; ?>"><?php _e( 'Select' , 'ssc' ); ?></button>
							<button id="icon-delete-<?php echo $item->ID; ?>" class="admin_sl_delete_icon_button button-primary fr" data-id="<?php echo $item->ID; ?>"><?php _e( 'Delete' , 'ssc' ); ?></button>
