...
DROP TABLE IF EXISTS `wp_cf_pro_messages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wp_cf_pro_messages` (
  `ID` bigint unsigned NOT NULL AUTO_INCREMENT,
  `cfp_id` bigint unsigned DEFAULT NULL,
...
--
-- Dumping data for table `wp_cf_pro_messages`
--

LOCK TABLES `wp_cf_pro_messages` WRITE;
/*!40000 ALTER TABLE `wp_cf_pro_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_cf_pro_messages` ENABLE KEYS */;
UNLOCK TABLES;
