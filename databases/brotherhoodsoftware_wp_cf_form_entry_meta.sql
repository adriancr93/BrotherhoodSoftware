...
--
-- Dumping data for table `wp_cf_form_entry_meta`
--

LOCK TABLES `wp_cf_form_entry_meta` WRITE;
/*!40000 ALTER TABLE `wp_cf_form_entry_meta` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_cf_form_entry_meta` ENABLE KEYS */;
UNLOCK TABLES;
